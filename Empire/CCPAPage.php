...
class CCPAPage {
    ...
    public function head() {
        if ( $this->empire->useCmpOneTrust() ) {
            ...
            echo '<script src="https://cdn.cookielaw.org/scripttemplates/otSDKStub.js" type="text/javascript" charset="UTF-8" data-domain-script="'
...
<body>
    <div>
        ...
        <p><label>Please check this box to opt out of any personal information being shared with our partner advertisers: <input type="checkbox" id="opt_out" onchange="update()" /></label></p>
        <p>
